...
urlpatterns = [
    ...
    path('api/categories/query=<str:query>' , api_view.searchByCategory, name='searchByCategory'),
    path('api/subcategory/query=<str:query>' , api_view.searchBySubcategory, name='searchBySubcategory'),
    path('api/brands/query=<str:query>' , api_view.searchByBrand, name='searchByBrand'),
    path('api/brands' , api_view.brand_api, name='brand_api'),
    path('api/tags' , api_view.tags_api, name='tags_api'),
    path('api/tags/query=<str:query>' , api_view.searchByTag, name='searchByTag'),
