...
from . views import product_list  , product_detail  , add_to_favourit , filter_by_price , filter_by_variations , category_list , submit_review , search_result ,  load_subcategories
